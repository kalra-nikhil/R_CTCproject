...
```{r}
biopsydata <- read_xlsx(here("Data/CTCanalysis_NK.xlsx"))
...
table_data |> 
  filter(Stanze_type != "Not_received") |>
  mutate(Stanze_type = fct_drop(Stanze_type)) |> 
  compare2qualvars(dep_vars = "CTCoutcome",
                   indep_var = "Stanze_type") |> 
  flextable() |> 
...
table_data |> 
  compare2qualvars(dep_vars = variables[-12],
                   indep_var = "CTCoutcome") |> 
  flextable()|> 
  bg(~p!=" ",1:5,bg = 'lightgrey') |> 
  align(~p==" ",1,align = "right")
